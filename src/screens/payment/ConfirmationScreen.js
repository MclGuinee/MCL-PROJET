    ...
    return (
      <Container style={styles.container}>
        ...
        <Content>
          ...
          <Text style={{ marginVertical: 10, color: "#5cb85c", alignSelf: "center" }}>Paiement effectué avec succès</Text>
          <Text style={{ marginVertical: 10, alignSelf: "center" }}>
            Votre commande a été validée. Le livreur va pouvoir la prendre en charge. Une fois effectuée, les coordonnées du livreur vont seront communiquées par notification et
            SMS.
          </Text>
